...
Les tubes `synthetic-v3+` sont des **schémas pédagogiques** loftés sur des repères osseux, avec sorties foraminales plus précises et troncs plus fins. Ce ne sont **pas** des segmentations IRM/cadavre. Le sciatique quitte le sacrum en **oblique descendant** (pas un moignon à 90° vers la crête iliaque), passe le grand foramen sciatique **sous / en profondeur du piriforme**, puis le corridor ischion–grand trochanter. Le radial suit le sillon spiral ; l’ulnaire le tunnel cubital ; le fémoral passe sous le ligament inguinal.
